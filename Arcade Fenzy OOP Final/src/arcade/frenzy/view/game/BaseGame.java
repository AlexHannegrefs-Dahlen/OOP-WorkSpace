...
public abstract class BaseGame extends BackgroundPanel implements Game_Interface, ActionListener {
	 ...
	 *            the background
	 */
	public BaseGame(Player player, Image image) {
		super(image);
		this.player = player;
	}
	 ...
	 *            active game
	 */
	public void gameOver(BaseGame baseGame) {
		this.getGame().getMainScreen().remove(baseGame);
